...
public class ClientUI extends Application {
    ...
    // TableView for holding leadership board 
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        ...
        vBoxButtons.getChildren().addAll(btnRoll, btnBuild, btnDevCards, btnTrade, btnEndTurn, btnTest, btnLeaderBrd);
    ...
    private void openLeaderboard() throws ClassNotFoundException, SQLException {
            ...
            while (rowSetRes.next()){
                System.out.println(rowSetRes.getString(1));
                System.out.println(rowSetRes.getInt(2));
                System.out.println(rowSetRes.getInt(3));
                System.out.println(rowSetRes.getInt(4));
                System.out.println(rowSetRes.getInt(5));
                System.out.println(rowSetRes.getInt(6));
            }
            ...
            TableColumn brickCol = new TableColumn("# of Brick");
            TableColumn lumberCol = new TableColumn("# of Lumber");
            TableColumn oreCol = new TableColumn("# of Ore");
            TableColumn wheatCol = new TableColumn("# of Wheat");
            TableColumn woolCol = new TableColumn("# of Wool");
            
            table.getColumns().addAll(usernameCol, brickCol, lumberCol, oreCol, wheatCol, woolCol);
